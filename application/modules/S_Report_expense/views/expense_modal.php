            ...
            {?>
                ...
                <tr>
                 ...
                 <!--   <td><?php //echo($row1->trans_cd); ?></td> -->
                    ...
                    <td><?php echo($row1->exp_amount); ?></td>
...
<div class="modal-footer">
    ...
    <button class="btn btn-secondary" type="button" onclick="location.href='<?php echo base_url();?>index.php/S_Report_expense/main'">Cancel</button>
