...
<div class="row">
    ...
    <div class="col-lg-12">
        <h1 class="page-header">Collection & Payment Summery</h1>
    </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        ...
        <p style="text-align: left; width:49%; display: inline-block;">Summery Report</p>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-6">
                ...
                <form role="form" method="POST" action= "<?php echo site_url('Report_expense_c/show_summeryRep') ?>" >
