...
<div id="divToPrint">
    ...
    <div>
        ...
        <h4 class="underline" style = "text-align: center">
            ...
            Payment Summery From: <?php echo(date("d/m/Y", strtotime($start_dt))); ?> To <?php echo(date("d/m/Y", strtotime($end_dt))) ; ?> 
        ...
        <table class="table table-striped" style="width: 100%;">
            ...
            <tbody style = "text-align: center">
                ...
                <tr>
                    <td><?php echo($key1->exp_type_id); ?></td> 
                    <td><?php echo($key1->expenses); ?></td> 
                    <td><?php echo($key1->tot_expense); ?></td> 
                </tr>
            ...
            <tfoot style = "text-align: center">
                <tr>
                    ...
                    <td >
                        <strong><?php echo $data2->exp_total; ?><strong>
                    </td>
                </tr>
            </tfoot>
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url();?>index.php/Report_expense_c/payment_summery'">Back</button>
