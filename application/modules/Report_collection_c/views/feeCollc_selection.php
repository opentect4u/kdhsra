...
<div class="row">
    ...
    <div class="col-lg-12">
        <h1 class="page-header">Class Wise Fee Collection</h1>
    </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
       ...
       <p style="text-align: left; width:49%; display: inline-block;">Fee Collection For: </p>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <form role="form" method="POST" action= "<?php echo site_url('Report_collection_c/view_collc_feeChart') ?>" >
