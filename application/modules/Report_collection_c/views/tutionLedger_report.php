...
<div id="divToPrint">
    ...
    <div>
        ...
        <h4 class="underline" style = "text-align: center">
            ...
            Tution Fee Ledger For : <?php echo $class.' / '.$stu_sec; ?>  From :<strong> <?php echo date('d-m-Y',strtotime($from_dt)); ?></strong>  To : <strong><?php echo date('d-m-Y',strtotime($to_dt)) ; ?></strong>
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url('index.php/Report_collection_c/tutionFee_ledger');?>'">Back</button>
