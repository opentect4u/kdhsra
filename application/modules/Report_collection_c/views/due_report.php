...
<div id="divToPrint">
    ...
    <div>
        ...
        <h4 class="underline" style = "text-align: center">
            ...
            <?php echo $fee->fees_name.'  '; ?> Due Report For Class: <?php echo $class.'  &  Section: '.$sec ; ?>
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url('index.php/Report_collection_c/due');?>'">Back</button>
