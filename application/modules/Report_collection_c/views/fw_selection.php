...
<div class="row">
    ...
    <div class="col-lg-12">
        <h1 class="page-header">Fee Wise Collection Report</h1>
    </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
       ...
       <p style="text-align: left; width:49%; display: inline-block;">Select Fee Type</p>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <form role="form" method="POST" action= "<?php echo site_url('Report_collection_c/show_fw_report') ?>" >
