...
<div id="divToPrint">
    ...
    <div>
        ...
        <h4 class="underline" style = "text-align: center">
            ...
            Fee Collection For :<strong> <?php echo $fee->fees_name; ?></strong>  In: <strong><?php echo$year ; ?></strong>
        ...
        <table class="table table-striped" style="width: 100%;">
            ...
            <thead style = "text-align: center">
                <tr>
                    ...
                    <td><strong>Collected Amount(Rs)</strong></td>
            ...
            <tfoot style = "text-align: center">
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;">
                        <strong><?php echo $row2->tot_fees_amt; ?></strong>
                    </td>
